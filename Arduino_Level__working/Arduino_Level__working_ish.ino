/*
  ...
  mpu-6050-level.ino
  Uses MPU-6050 IMU
  Displays on 128x64 OLED and LED (not used in our code)
...
void loop(){
  ...
  // Check Angle for Level LEDs
    ...
    } else if ((angle_pitch_output > -5.00) && (angle_pitch_output < -2.01)) {
    // Turn on Level LED
    ...
    } else if ((angle_pitch_output < 2.00) && (angle_pitch_output > -2.00)) {
    // Turn on Level LED
    digitalWrite(levelLED_neg1, LOW);
    digitalWrite(levelLED_neg0, LOW);
    ...
    } else if ((angle_pitch_output > 2.01) && (angle_pitch_output < 5.00)) {
    // Turn on Level LED
    digitalWrite(levelLED_neg1, LOW);
    digitalWrite(levelLED_neg0, LOW);
    digitalWrite(levelLED_level, LOW);
    ...
    } else if (angle_pitch_output > 5.01) {
    // Turn on Level LED
    digitalWrite(levelLED_neg1, LOW);
    digitalWrite(levelLED_neg0, LOW);
    digitalWrite(levelLED_level, LOW);
